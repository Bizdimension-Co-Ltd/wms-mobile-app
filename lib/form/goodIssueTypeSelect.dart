...
class GoodIssueTypeSelect extends StatefulWidget {
  const GoodIssueTypeSelect({Key? key, this.indBack})
      : super(
          key: key,
        );
  final indBack;
  @override
  State<GoodIssueTypeSelect> createState() => _GoodIssueTypeSelectState();
}

class _GoodIssueTypeSelectState extends State<GoodIssueTypeSelect> {
  int a = 1;
  int selectedRadio = -1;
