...
import 'package:wms_mobile/presentations/inventory/good_issue/component/listDocument.dart';
import 'package:wms_mobile/presentations/inventory/good_issue/component/listOffLineDocument.dart';
...
class GoodIssueListScreen extends StatefulWidget {
  const GoodIssueListScreen({super.key});

  @override
  State<GoodIssueListScreen> createState() => _GoodIssueListScreenState();
}

class _GoodIssueListScreenState extends State<GoodIssueListScreen>
  ...
  Future<void> getListGR(pick) async {
    try {
      final response = await dio.get(
          '/InventoryGenExits${pick != null && pick != selectedDate ? "?\$filter=DocDate eq '$pick'" : ''}',
