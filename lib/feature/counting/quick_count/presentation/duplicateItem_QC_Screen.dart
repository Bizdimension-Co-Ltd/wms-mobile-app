...
class DuplicateItemQCPage extends StatefulWidget {
  const DuplicateItemQCPage({super.key, this.barCode, required this.items});

  final dynamic barCode;
  final List<dynamic> items;
  @override
  State<DuplicateItemQCPage> createState() => _DuplicateItemGPOPageState();
}

class _DuplicateItemGPOPageState extends State<DuplicateItemQCPage> {
