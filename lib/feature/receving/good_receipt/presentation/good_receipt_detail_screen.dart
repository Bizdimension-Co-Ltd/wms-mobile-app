...
class GoodReceiptDetailScreen extends StatefulWidget {
  const GoodReceiptDetailScreen(
  ...
  @override
  State<GoodReceiptDetailScreen> createState() =>
      _GoodReceiptDetailScreenState();
}

/// [AnimationController]s can be created with `vsync: this` because of
/// [TickerProviderStateMixin].
class _GoodReceiptDetailScreenState extends State<GoodReceiptDetailScreen>
