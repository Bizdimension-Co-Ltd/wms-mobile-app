...
class DuplicateItemRTRPage extends StatefulWidget {
  const DuplicateItemRTRPage({super.key, this.barCode, required this.items});

  final dynamic barCode;
  final List<dynamic> items;
  @override
  State<DuplicateItemRTRPage> createState() => _DuplicateItemGPOPageState();
}

class _DuplicateItemGPOPageState extends State<DuplicateItemRTRPage> {
