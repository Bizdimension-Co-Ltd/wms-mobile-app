...
class DuplicateItemDLRPage extends StatefulWidget {
  const DuplicateItemDLRPage({super.key, this.barCode, required this.items});

  final dynamic barCode;
  final List<dynamic> items;
  @override
  State<DuplicateItemDLRPage> createState() => _DuplicateItemGPOPageState();
}

class _DuplicateItemGPOPageState extends State<DuplicateItemDLRPage> {
