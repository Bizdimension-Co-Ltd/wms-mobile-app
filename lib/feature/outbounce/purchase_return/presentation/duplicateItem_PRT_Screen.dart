...
class DuplicateItemPRTPage extends StatefulWidget {
  const DuplicateItemPRTPage({super.key, this.barCode, required this.items});

  final dynamic barCode;
  final List<dynamic> items;
  @override
  State<DuplicateItemPRTPage> createState() => _DuplicateItemGPOPageState();
}

class _DuplicateItemGPOPageState extends State<DuplicateItemPRTPage> {
