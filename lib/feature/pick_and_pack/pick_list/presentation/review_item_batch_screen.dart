...
class ReviewItemBatchScreen extends StatelessWidget {
  const ReviewItemBatchScreen({super.key, required this.entity});
              ...
              children: [
                ...
                Wrap(
                  children: [
                    Container(
                      ...
                      child: Text('#Batches. : ${entity.pickedQuantity}'),
                    ),
                    Container(
                      margin: const EdgeInsets.all(6),
                      padding: const EdgeInsets.symmetric(
                ...
                Expanded(
                  child: Scrollbar(
                    child: ListView(
                      // crossAxisAlignment: CrossAxisAlignment.start,
                      children: entity.batchNumbers
                              ?.map((item) => GestureDetector(
                                    child: ItemRow(
                                      item: item,
                                      remain: entity.previouslyReleasedQuantity
                                          .toString(),
                                    ),
                                  ))
                              .toList() ??
                ...
                Expanded(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Mfg. Date : ${item.manufacturingDate}'),
                    ],
                  ),
                ),
                Expanded(
