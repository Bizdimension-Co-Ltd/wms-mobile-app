...
import 'cubit/warehouse_transfer_cubit.dart';

class CreateWarehouseTransferScreen extends StatefulWidget {
  const CreateWarehouseTransferScreen({super.key});

  @override
  State<CreateWarehouseTransferScreen> createState() =>
      _CreateWarehouseTransferScreenState();
}

class _CreateWarehouseTransferScreenState
    extends State<CreateWarehouseTransferScreen> {
  ...
  late WarehouseTransferCubit _bloc;
  ...
  void initState() {
    init();
    _bloc = context.read<WarehouseTransferCubit>();
            ...
            child: Column(
              ...
              children: [
                ...
                Input(
                  ...
                  controller: toWarehouse,
                  readOnly: true,
                  onPressed: onChangeToWarehouse,
                ),
                Input(
                  controller: sbinCode,
                  label: 'F.Bin.',
